...
export default function WhatsAppChat() {
  ...
  const phoneNumber = '447418373634'; // +44 7418 373634 without + and spaces
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="group flex items-center gap-3 bg-[#25D366] hover:bg-[#20BA5A] text-white font-bold rounded-full shadow-2xl hover:shadow-[#25D366]/50 transition-all duration-300 hover:scale-110"
