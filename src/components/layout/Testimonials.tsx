    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-4">Partner Feedback</h2>
          <p className="text-white/40">Real stories from our wholesale and retail partners.</p>
        </div>
