      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
            ...
            <div className="animate-in slide-in-from-right-4 duration-700 fade-in">
                 ...
                 {/* Description */}
                 <div className="mb-8 p-6 bg-[#white] rounded-2xl border-l-4 border-[#124559] bg-gradient-to-r from-white to-[#eff6e0]/30 shadow-sm">
                    <h3 className="text-lg font-bold text-[#01161e] mb-4 uppercase tracking-wider text-xs opacity-70">Product Overview</h3>
                    <div className="text-[#598392] leading-relaxed text-lg space-y-4">
                        <p className="font-medium text-[#124559]">
                            Buy {product.name} in bulk at competitive wholesale pricing. Ideal for resellers, smoke shops, and distributors across the USA.
                        </p>
                        <p>{product.description}</p>
                        
                        <div className="mt-6 pt-6 border-t border-[#aec3b0]/30">
                            <h4 className="text-sm font-bold text-[#01161e] uppercase tracking-wider mb-3">Bulk Order Benefits:</h4>
                            <ul className="grid grid-cols-1 gap-2 text-sm font-bold text-[#124559]">
                                <li className="flex items-center gap-2">
                                    <svg className="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                    MOQ-friendly pricing
                                </li>
                                <li className="flex items-center gap-2">
                                    <svg className="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                                    Fast shipping
