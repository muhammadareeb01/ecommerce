  ...
  return (
    <div className="bg-[#eff6e0] min-h-screen py-16 px-4 sm:px-8 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="text-center mb-16 animate-in slide-in-from-bottom-4 duration-700 fade-in relative">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-[#01161e] mb-6 tracking-tighter leading-tight drop-shadow-sm">
            Contact BulkVapes.us – Wholesale Vape Supplier USA
          </h1>
          <p className="text-xl md:text-2xl text-[#598392] leading-relaxed max-w-3xl mx-auto mb-8 font-medium">
            Need help with a bulk order? Contact our wholesale team via email or WhatsApp.
          </p>
          
          <a
            href="https://wa.me/447418373634" 
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#124559] text-[#eff6e0] px-8 py-4 rounded-full text-lg font-black hover:bg-[#01161e] transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 transform group"
          >
            <span>Talk to a Wholesale Agent</span>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#aec3b0]/50 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <a href="https://wa.me/447418373634" className="text-green-600 font-bold hover:underline">
                  Chat with us
                </a>
              </div>
            </div>
